...
export const MedicoStudyTimetableInputSchema = z.object({
  ...
  weakSubjects: z.string().optional().describe('Optional free-text description of weaker subjects or topics to prioritize (e.g., "cardiac pharmacology, ECGs"). The AI will use this for more focused scheduling.'),
});
